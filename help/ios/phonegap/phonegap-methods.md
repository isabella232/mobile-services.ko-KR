...
In the `AppDelegate` generated by Cordova, call `[ADBMobile setAdvertisingIdentifier:]` in the `application:didFinishLaunchingWithOptions:` delegate method. 자세한 내용은 [구성 방법을](/help/ios/configuration/sdk-methods.md)참조하십시오.
