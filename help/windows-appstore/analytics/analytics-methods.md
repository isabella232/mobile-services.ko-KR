...
The SDK currently has support for multiple Adobe Experience Cloud Solutions], including Analytics], Target], and Audience Manager]. 메서드에는 솔루션에 따라 접두사가 붙습니다. Analytics 메서드는 "Analytics"로 시작합니다.
